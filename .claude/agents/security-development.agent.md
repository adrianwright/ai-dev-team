...
## Security Posture: POC-Grade, Not Compliance-Grade

This is a **non-production POC**. It does not process live student data and is not subject to FERPA, GDPR, or other compliance frameworks. Security controls should be:
...
- Seed data in `SeedData/DataSeeder.cs` with `@university.edu` emails and fake phone numbers
